 ...
 * @author Windows 7
 */
public class RemovePerusahaan extends javax.swing.JFrame {

    /**
     * Creates new form RemovePerusahaan
     */
    public RemovePerusahaan() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemovePerusahaan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemovePerusahaan().setVisible(true);
            }
        });
    }
